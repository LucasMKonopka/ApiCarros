...
class _HomePageState extends State<HomePage> {
              ...
              children: <Widget>[
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                        image: carros[index].img != null
                            ? FileImage(File(carros[index].img))
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Text(carros[index].marca,
                          style: TextStyle(
                              fontSize: 22.0, fontWeight: FontWeight.bold)),
                      Text(carros[index].modelo ?? "",
                          style: TextStyle(fontSize: 22.0)),
                      Text(carros[index].ano ?? "",
                          style: TextStyle(fontSize: 22.0)),
                      Text(
                        carros[index].cor ?? "",
  ...
  void showCarroPage({Carro carro}) async {
    final recCarro = await Navigator.push(context,
        MaterialPageRoute(builder: (context) => CarroPage(carro: carro)));
    if (recCarro != null) {
      if (carro != null) {
